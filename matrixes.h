...
static void get_K(vector<mat> &K_arr)
{
	...
	K0(4, 0) = -16.7; K0(5, 0) = -36.7; K0(6, 0) = 1.0; K0(7, 0) = 1.0;

	K0(0, 1) = -90.5; K0(1, 1) = 410.5; K0(2, 1) = 10.8; K0(3, 1) = -6.0;
	K0(4, 1) = 7.8; K0(5, 1) = 4.9; K0(6, 1) = 1.0; K0(7, 1) = 1.0;

	K0(0, 2) = -51.8; K0(1, 2) = 10.8; K0(2, 2) = 162.8; K0(3, 2) = 24.6;
	K0(4, 2) = 12.9; K0(5, 2) = 16.8; K0(6, 2) = 1.0; K0(7, 2) = 1.0;

	K0(0, 3) = -20.1; K0(1, 3) = -6.0; K0(2, 3) = 24.6; K0(3, 3) = 110.1;
	K0(4, 3) = 7.2; K0(5, 3) = 14.9; K0(6, 3) = 1.0; K0(7, 3) = 1.0;

	K0(0, 4) = -16.7; K0(1, 4) = 7.8; K0(2, 4) = 12.9; K0(3, 4) = 7.2;
	K0(4, 4) = 86.0; K0(5, 4) = 10.6; K0(6, 4) = 1.0; K0(7, 4) = 1.0;

	K0(0, 5) = -36.7; K0(1, 5) = 4.9; K0(2, 5) = 16.8; K0(3, 5) = 14.9;
	K0(4, 5) = 10.6; K0(5, 5) = 92.0; K0(6, 5) = 1.0; K0(7, 5) = 1.0;

	K0(0, 6) = 1.0; K0(1, 6) = 1.0; K0(2, 6) = 1.0; K0(3, 6) = 1.0;
	K0(4, 6) = 1.0; K0(5, 6) = 1.0; K0(6, 6) = 1.0; K0(7, 6) = 1.0;

	K0(0, 7) = 1.0; K0(1, 7) = 1.0; K0(2, 7) = 1.0; K0(3, 7) = 1.0;
	K0(4, 7) = 1.0; K0(5, 7) = 1.0; K0(6, 7) = 1.0; K0(7, 7) = 1.0;
...
static void get_D(vector<mat> &D_arr)
{
	...
	D0(0, 0) = 39.2; D0(1, 0) = -13.5; D0(2, 0) = -6.0; D0(3, 0) = -5.1;
	D0(4, 0) = -5.4; D0(5, 0) = -7.2; D0(6, 0) = -1.0; D0(7, 0) = -1.0;

	D0(0, 1) = -13.5; D0(1, 1) = 32.7; D0(2, 1) = -4.0; D0(3, 1) = -3.8;
	D0(4, 1) = -4.1; D0(5, 1) = -5.3; D0(6, 1) = -1.0; D0(7, 1) = -1.0;

	D0(0, 2) = -6.0; D0(1, 2) = -4.0; D0(2, 2) = 18.5; D0(3, 2) = -1.8;
	D0(4, 2) = -1.9; D0(5, 2) = -2.8; D0(6, 2) = -1.0; D0(7, 2) = -1.0;

	D0(0, 3) = -5.1; D0(1, 3) = -3.8; D0(2, 3) = -1.8; D0(3, 3) = 16.9;
	D0(4, 3) = -1.7; D0(5, 3) = -2.5; D0(6, 3) = -1.0; D0(7, 3) = -1.0;

	D0(0, 4) = -5.4; D0(1, 4) = -4.1; D0(2, 4) = -1.9; D0(3, 4) = -1.7;
	D0(4, 4) = 17.5; D0(5, 4) = -2.4; D0(6, 4) = -1.0; D0(7, 4) = -1.0;

	D0(0, 5) = -7.2; D0(1, 5) = -5.3; D0(2, 5) = -2.8; D0(3, 5) = -2.5;
	D0(4, 5) = -2.4; D0(5, 5) = 22.2; D0(6, 5) = -1.0; D0(7, 5) = -1.0;


	D0(0, 6) = -1.0; D0(1, 6) = -1.0; D0(2, 6) = -1.0; D0(3, 6) = -1.0;
	D0(4, 6) = -1.0; D0(5, 6) = -1.0; D0(6, 6) = 6.0; D0(7, 6) = -1.0;

	D0(0, 7) = -1.0; D0(1, 7) = -1.0; D0(2, 7) = -1.0; D0(3, 7) = -1.0;
	D0(4, 7) = -1.0; D0(5, 7) = -1.0; D0(6, 7) = -1.0; D0(7, 7) = 6.0;
