...
static void get_K(vector<mat> &K_arr)
{
	...
	K(0, 0) = 700.7; K(1, 0) = -90.5; K(2, 0) = -51.8; K(3, 0) = -21.0;
	...
	K(0, 3) = -21.0; K(1, 3) = -6.0; K(2, 3) = 24.6; K(3, 3) = 110.0;
	...
	K0(0, 0) = 700.7; K0(1, 0) = -90.5; K0(2, 0) = -51.8; K0(3, 0) = -21.0;
	K0(4, 0) = -16.7; K0(5, 0) = -36.7; K0(6, 0) = 0.0; K0(7, 0) = 0.0;

	K0(0, 1) = -90.5; K0(1, 1) = 410.5; K0(2, 1) = 10.8; K0(3, 1) = -6.0;
	K0(4, 1) = 7.8; K0(5, 1) = 4.9; K0(6, 1) = 0.0; K0(7, 1) = 0.0;

	K0(0, 2) = -51.8; K0(1, 2) = 10.8; K0(2, 2) = 162.8; K0(3, 2) = 24.6;
	K0(4, 2) = 12.9; K0(5, 2) = 16.8; K0(6, 2) = 0.0; K0(7, 2) = 0.0;

	K0(0, 3) = -21.0; K0(1, 3) = -6.0; K0(2, 3) = 24.6; K0(3, 3) = 110.0;
	K0(4, 3) = 7.2; K0(5, 3) = 14.9; K0(6, 3) = 0.0; K0(7, 3) = 0.0;

	K0(0, 4) = -16.7; K0(1, 4) = 7.8; K0(2, 4) = 12.9; K0(3, 4) = 7.2;
	K0(4, 4) = 86.0; K0(5, 4) = 10.6; K0(6, 4) = 0.0; K0(7, 4) = 0.0;

	K0(0, 5) = -36.7; K0(1, 5) = 4.9; K0(2, 5) = 16.8; K0(3, 5) = 14.9;
	K0(4, 5) = 10.6; K0(5, 5) = 92.0; K0(6, 5) = 0.0; K0(7, 5) = 0.0;
